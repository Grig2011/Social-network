        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatComment_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ChatComment_chatMessages_ChatMessageId",
                        column: x => x.ChatMessageId,
                        principalTable: "chatMessages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatComment_notifications_NotificationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rewiews_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quesions_Profiles_UserId",
                        column: x => x.UserId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Quesions_Topics_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    QuesionId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatComment_ApplicationUserId",
                table: "ChatComment",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatComment_ChatMessageId",
                table: "ChatComment",
                column: "ChatMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatComment_NotificationId",
                table: "ChatComment",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quesions_TopicId",
                table: "Quesions",
                column: "TopicId");

            migrationBuilder.CreateIndex(
                name: "IX_Quesions_UserId",
                table: "Quesions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Rewiews_ProfileId",
                table: "Rewiews",
                column: "ProfileId");
